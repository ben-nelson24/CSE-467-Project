...
```
What that command does is it filters out files that are larger than 10,000,000 bytes, doesn't have any antivirus flags, and filters to a max item count of 20,000
